...
CREATE TABLE USERS (USER_ID BIGINT GENERATED ALWAYS AS IDENTITY NOT NULL, NAME VARCHAR(20) NOT NULL, PASSWORD VARCHAR(30) NOT NULL, PRIMARY KEY (USER_ID));
INSERT INTO USERS (NAME, PASSWORD) VALUES('adam','adam');